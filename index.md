...
- ## 问答
    ...
    - [回答发布](/docs/{{version}}/answer/answer-store)
    - [回答详情](/docs/{{version}}/answer/answer-show)
    - [回答删除](/docs/{{version}}/answer/answer-destroy)
    - [回答编辑](/docs/{{version}}/answer/answer-update)
    - [回答列表](/docs/{{version}}/answer/answer-index)
